...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.1, n=0, alpha=0.69, E0=(107.9,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """Default""",
    longDesc = 
"""
Universal BEP relation for all metals from Wang et al. "Universal transition state scaling relations for (de)hydrogenation over transition metals", Physical chemistry chemical physics, 2011, 13, 20760-20765, DOI:10.1039/c1cp20547a.
""",
)
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.1, n=0, alpha=0, E0=(3.8,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 10,
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=1.51, n=0, alpha=0, E0=(58,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """CH4 dissociative adsorption""",
    longDesc = 
"""
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.342, n=0, alpha=0, E0=(42.7,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """C2H6 dissociative adsorption""",
    longDesc = 
"""
Data from G.W. Cushing, J.K. Navin, S.B. Donald, L. Valdez, V. Johanek, I. Harrison "C-H Bond Activation of Light Alkanes on Pt(111): Dissociative Sticking Coefficients, Evans-Polanyi Relation, and Gas-Surface Energy Transfer" J. Phys. Chem. C, 2010, 114, 17222-17232, DOI:10.1021/jp105073.
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.198, n=0, alpha=0, E0=(33.6,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """C3H8 dissociative adsorption""",
    longDesc = 
"""
Data from G.W. Cushing, J.K. Navin, S.B. Donald, L. Valdez, V. Johanek, I. Harrison "C-H Bond Activation of Light Alkanes on Pt(111): Dissociative Sticking Coefficients, Evans-Polanyi Relation, and Gas-Surface Energy Transfer" J. Phys. Chem. C, 2010, 114, 17222-17232, DOI:10.1021/jp105073.
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.033, n=0, alpha=0.76, E0=(107.1,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """CH3OH dissociative adsorption""",
    longDesc = 
"""
...
entry(
    ...
    kinetics = StickingCoefficientBEP(A=0.025, n=0, alpha=0.69, E0=(107.9,'kJ/mol'), Tmin=(200,'K'), Tmax=(3000,'K')),
    rank = 0,
    shortDesc = """Default""",
    longDesc = 
"""
...
entry(
    ...
    longDesc = 
"""
R9 from table 1 in Pynta─An Automated Workflow for Calculation of Surface and Gas-Surface Kinetics Johnson et al. https://doi/full/10.1021/acs.jcim.3c00948
""",
)
